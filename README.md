...
- URL: https://outlook-translator.vercel.app/taskpane.html
...
1. https://vercel.com/dashboard 접속 (by 유성 계정)
...
1. https://github.com/skt-yusung/outlook-translator/blob/main/manifest.xml 파일 다운로드
2. https://aka.ms/olksideload 접속 및 로그인
3. 일반 → 추가 기능 관리
4. 내 추가 기능 → 사용자 지정 추가 기능 추가 → 파일에서 추가
5. `manifest.xml` 선택
6. 설치
